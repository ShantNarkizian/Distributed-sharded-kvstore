...
class TestHW3(unittest.TestCase):
    ...
    def test_a_get_shard_ids(self):
        ...
        print("shardIdsFromNode1 = " + str(shardIdsFromNode1))
        ...
        print("shardIdList = " + str(self.shardIdList))
    def test_b_shard_id_members(self):

        print("\n###################### Getting the Members of Shard IDs ######################\n")

        print("shardIdList in test_b = " + str(shardIdList))
        print("shardIdList[0] = " + str(self.shardIdList[0]))
